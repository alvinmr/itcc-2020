                            	...
                            	<tr>
                            		...
                            		<td>
                            			@if ($value->proposalLink == null)
                            				Belum Upload
                            			@else
                            				<a target="_blank" href="{{ asset('/uploads/berkas/'.$value->proposalLink) }}">{{ $value->title }}</a>
                            			@endif
                            		</td>
                            		<td>
                            			@if ($value->file == null)
                            				Belum Upload
                            			@else
                            				<a target="_blank" href="/uploads/poster/{{ $value->file }}">{{ $value->file }}</a>
                            			@endif
                            		</td>
                                    <td>
                                        @if ($value->powerPointLink == null)
                                            Belum Upload
                                        @else
                                            <a target="_blank" href="{{ $value->powerPointLink }}">{{ $value->powerPointLink }}</a>
                                        @endif
                                    </td>
                            	</tr>
                            @endforeach
