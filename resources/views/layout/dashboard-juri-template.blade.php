	...
	<div id="wrapper">
        ...
        <div class="sidebar" style="background: linear-gradient(0deg, rgba(32,32,32,1) 0%, rgba(22,22,22,1) 35%);">
            <div class="brand" style="background-color: transparent;">
                <a href="index.html"><img src="{{asset('assets2020/img/desain-2020/logo-red.png')}}" alt="ITCC Logo" class="img-responsive logo" width="100px" height="100px"></a>
            </div>
        ...
        <div class="main">
            ...
            <footer>
	            <div class="container-fluid">
	                <p class="copyright" style="color: #021B79;">&copy; Information Technology Creative Competition 2020 | <a href="http://it.unud.ac.id" style="color: #0575E6;">Teknologi Informasi Udayana</a></p>
	            </div>
        	</footer>
        </div>
	</div>
