...
<head>
    ...
    <!--fav icon-->
    <link rel="icon" type="image/jpg" href="{{asset('assets2020/img/desain-2020/logo-red.png')}}">
    ...
    <div id="wrapper">
        ...
        <div class="sidebar" style="background: linear-gradient(0deg, rgba(32,32,32,1) 0%, rgba(22,22,22,1) 35%);">
            <div class="brand" style="background-color: transparent;">
                <a href="/"><img src="{{asset('assets2020/img/desain-2020/logo-red.png')}}" alt="ITCC Logo" class="img-responsive logo" width="100px" height="100px"></a>
            </div>
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li class="hidden-lg"><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: rgba(33, 57, 80, 1);"><img src="{{asset('asset/images/user.png')}}" width="30px" height="30px" class="img-circle" alt="Avatar"> <span style="color: white">{{Auth::guard('admin')->user()->fullname}}</span></a></li>
                        ...
                        {{-- lihat upload file INOVASI --}}
                        @if(Auth::user()->competition_id == 3)
                        <li><a href="{{ route('lihatfileInovasi.index') }}"><i class="glyphicon glyphicon-cloud-upload"></i> <span>Lihat File Terupload</span></a></li>
                        @endif
                        {{--  --}}
                        ...
                        <li><a href="/admin/hasil_lomba"><i class="glyphicon glyphicon-king"></i> <span>Hasil Lomba</span></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar-menu" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="background-color: transparent;">
