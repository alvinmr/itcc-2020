...
<div class="container-fluid">
    ...
    <div class="col-sm-12">
        <div class="alert alert-warning">
            ...
            <p style="text-align: justify;text-justify: inter-word;">Pastikan Anda telah melengkapi data peserta, biaya pendaftaran dan memverifikasikan data ke panitia ITCC 2020. Salam hangat dari admin ITCC 2020. Silakan lihat langkah-langkah yang harus anda lakukan pada tombol berikut. </p><br>
            <button class="btn btn-info btn-lg" type="button" data-toggle="modal" data-target="#modalInfo">Lihat Langkah-langkah</button>
        </div>
    </div>
    @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if(Auth::user()->verified==1)
                                ...
                                @else
                                <b>Belum Terverifikasi</b> <i class="glyphicon glyphicon-time" style="color:#de9b00;"></i><br>
                                @endif
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('dashboard.store')}}" method="post" class="form-horizontal" accept-charset="utf-8"  enctype="multipart/form-data">
                        ...
                        @if (Auth::user()->participants->first()->buy_shirt == 1)
                            {{-- <div class="form-group row" id="ukuran-baju">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @if (Auth::user()->competition_id != 3)
                                        <small>Desain baju dapat dilihat </small> <a data-toggle="modal" data-target="#sizeChart">DISINI</a>
                                        @if ($errors->has('size'))
    ...
    <div id="modalInfo" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p align="center">Lengkapi kesiapan anda untuk perlombaan dengan mengikuti langkah berikut.</p>

                    <div class="row" style="margin-top: 50px;">
                        <div class="col-md-5">
                            <center>
                                <img src="asset/icon/11.png" style="width: 25%; margin-bottom: 5px;">
                                <p><b>Lengkapi data anggota tim</b> Anda</p>
                            </center>
                        </div>
                        ...
                        <div class="col-md-5 mt-2">
                            <center>
                                ...
                                <p>Lakukan pembayaran biaya lomba pada menu <a href="{{url('/verifikasi')}}"><b><u>Pembayaran Pendaftaran</u></b></a></p>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row mt-20">
                        <div class="col-md-5">
                            <center>
                                ...
                                <p><b>Upload berkas untuk keperluan lomba</b></p>
                            </center>
                        </div>
                        <div class="col-md-2 visible-lg">
                        ...
                        <div class="col-md-5 mt-2">
                            <center>
                                ...
                                <p><b>Konfirmasi pembayaran</b> yang telah Anda lakukan (Dengan menghubungi panitia ITCC atau menunggu maksimal 2 x 24 Jam)</p>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-md-5">
                            <center>
                                ...
                                <p><b>Siapkan diri</b> untuk mengikuti perlombaan</p>
                            </center>
                        </div>
                    </div>
