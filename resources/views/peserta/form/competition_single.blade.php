    ...
    <div class="container">
    	<div class="row" style="margin-top: 90px;">
    		...
    		<div class="d-none d-xl-block col-md-4 box" style="background: #232323; max-height: 650px; margin-top: 50px;">
                <img src="{{asset('asset1/images/2019/logo.png')}}" style=" width: 70%;margin-left: 65px;margin-top: 70px;margin-bottom:20px;" class="img-responsive center-block ">
                     
                <h5 style="color:#a2c8cc; text-align: center;">"Tech Breakthrough to Achieve Sustainable Development Goals in Industry 4.0 Era"</h5>
        			...
        			<div class="card-body" style="padding: 32px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <small>Gambar dalam bentuk file .jpg ukuran maksimal 500 Kb</small>
