...
class GroupRegisterController extends Controller
{
    ...
    {   
        ...
        return redirect()->to('login')->with('success','Kami telah mengirim link untuk aktivasi akun anda, silakan cek inbox ataupun spam email anda'); 
    ...
    public function seeEmail(){
        return view('emails.verification-email-new');
    }
    ...
    public function showInovasiRegistrationForm()
    {
        /*$data['harga_baju'] = Shirt::find(1)->price;*/
        $data['competition'] = Competition::find(3);
        return view('peserta.sign-up-inovasi-kreatif', $data);
    }
    ...
    public function showSoftdevRegistrationForm()
    {
        /*$data['harga_baju'] = Shirt::find(1)->price;*/
        $data['competition'] = Competition::find(5);
        return view('peserta.sign-up-software-development', $data);
    }
